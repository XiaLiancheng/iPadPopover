...
- (void)viewDidLoad {
    ...
    //iOS8之前
//    UISearchBar * seachBar = [[UISearchBar alloc]initWithFrame:CGRectZero];
//    UISearchDisplayController * searchController = [[UISearchDisplayController alloc]initWithSearchBar:seachBar contentsController:self];
